...
public class SeedController {
    ...
    public ResponseEntity<?> seedData() {
        ...
        products.add(make("Nintendo Switch OLED", "7-inch OLED screen, 64GB internal storage, enhanced audio.", 349.99, "Electronics", "Nintendo", 4.8, 4123, 100, 0, sid, "https://images.unsplash.com/photo-1617260588876-0f9c2d1e2e1e?w=600&q=80", List.of("gaming","console","nintendo","switch")));
        products.add(make("Bose QuietComfort Earbuds II", "Personalized noise cancellation and sound performance.", 299.99, "Electronics", "Bose", 4.7, 1542, 60, 5, sid, "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=600&q=80", List.of("earbuds","bose","noise-cancelling","audio")));
        ...
        products.add(make("Vans Old Skool Sneakers", "Classic skate shoe with iconic side stripe. Suede and canvas upper.", 69.99, "Fashion", "Vans", 4.8, 3421, 250, 0, sid, "https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?w=600&q=80", List.of("shoes","vans","skate","sneakers")));
        products.add(make("Fossil Gen 6 Smartwatch", "Wear OS by Google, heart rate tracking, stainless steel case.", 299.99, "Fashion", "Fossil", 4.5, 654, 40, 15, sid, "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&q=80", List.of("watch","fossil","smartwatch","accessories")));
        ...
        products.add(make("Ninja Foodi 10-in-1 Oven", "Air fry, bake, roast, broil, toast, and more. XL capacity.", 229.99, "Home", "Ninja", 4.7, 1872, 60, 10, sid, "https://images.unsplash.com/photo-1584269600464-37b1b58a9fe7?w=600&q=80", List.of("oven","kitchen","ninja","baking")));
        products.add(make("Bose SoundLink Revolve+ II", "Portable Bluetooth speaker, 360-degree sound, water-resistant.", 329.99, "Home", "Bose", 4.8, 2341, 80, 0, sid, "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=600&q=80", List.of("speaker","audio","bose","bluetooth")));
        ...
        products.add(make("NERF Elite 2.0 Commander", "Fires up to 90 feet. Includes 12 official NERF darts.", 14.99, "Toys", "NERF", 4.5, 1543, 300, 15, sid, "https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?w=600&q=80", List.of("nerf","blaster","kids","play")));

        // ── SPORTS ───────────────────────────────────────────────────────────────
        products.add(make("Wilson Evolution Basketball", "The #1 indoor game basketball in America. Microfiber composite leather cover.", 79.99, "Sports", "Wilson", 4.9, 5432, 120, 0, sid, "https://images.unsplash.com/photo-1519861531473-9200262188bf?w=600&q=80", List.of("basketball","sports","wilson","indoor")));
        products.add(make("Bowflex SelectTech 552 Dumbbells", "Adjustable from 5 to 52.5 lbs. Replaces 15 sets of weights.", 429.99, "Sports", "Bowflex", 4.8, 8765, 50, 10, sid, "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=600&q=80", List.of("fitness","dumbbells","weights","homegym")));
        products.add(make("Spalding NBA Official Backboard", "54\" polycarbonate backboard, Pro Slam rim, heavy duty padding.", 249.99, "Sports", "Spalding", 4.7, 1234, 30, 5, sid, "https://images.unsplash.com/photo-1546519638-68e109498ffc?w=600&q=80", List.of("basketball","hoop","sports","outdoor")));
